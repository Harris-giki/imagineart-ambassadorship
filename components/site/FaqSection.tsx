...
function PlusMinus({ open }: { open: boolean }) {
  return (
    <span className="shrink-0 flex items-center justify-center w-8 h-8 text-content-primary">
    ...
    <Reveal delay={delay} className="border-b border-border-primary">
      ...
      >
        <span
          ...
          style={{
            ...
            color: open ? "#C8AAFF" : "var(--color-content-primary)",
          }}
        >
          {q}
        </span>
      ...
      >
        <div className="overflow-hidden">
          <p className="font-sans text-[15.5px] leading-[1.72] text-content-secondary pb-6 max-w-[68ch]">{a}</p>
        </div>
      </div>
    </Reveal>
  )
