...
const variants: Record<Variant, string> = {
  brand: "bg-content-primary text-white transition-colors hover:bg-black",
  ghost:
...
type AnchorProps = CommonProps & Omit<ComponentPropsWithoutRef<typeof Link>, "className" | "children">

export function ButtonLink({ variant, size, className, children, href, ...rest }: AnchorProps) {
  return (
